 ...
 *
 * @see \EasyCorp\Bundle\EasyAdminBundle\Orm\EntityRepository
 */
class ExtendedEntityRepository implements EntityRepositoryInterface
{
     ...
     * @param string[]                                                     $whereStrings
     *
     * @return \Doctrine\ORM\QueryBuilder
     */
    public function createQueryBuilderWithWhere(
        SearchDto $searchDto,
        EntityDto $entityDto,
        ...
        foreach ($whereStrings as $string) {
